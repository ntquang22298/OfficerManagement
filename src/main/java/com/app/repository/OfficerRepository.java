...
public interface OfficerRepository extends JpaRepository<Officer, Long> {
    ...
    @Query(value = "Select o from Officer o inner join o.researchAreas r where r.id =:id ")
    public List<Officer> findAllByResearchArea(@Param("id") Long id);
    ...
    @Query(value = "Select o from Officer o inner join o.unit u where u.id =:id ")
    public List<Officer> getAllByUnit(@Param("id") Long id);
}
